...
- BaseInfo 模块没有渲染问候语、GIGA Index、Beans 以及招商经理卡片，导致 node 833-28679 与 89-10615 的交互完全缺失。
- 现有 spec/proposal 中包含乱码，评审及实现团队无法准确读取需求，需要改写为 UTF-8 文案。

## What Changes
- 构建 BaseInfo Summary 行：按 node 833-27929 排列问候语、等级徽章、ID、GIGA Index、Beans、招商经理入口及分隔线。
